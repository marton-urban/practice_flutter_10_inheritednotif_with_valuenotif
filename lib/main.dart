...
Future main() async {
  ...
  runApp(
    StateInheritedNotifier(
      notifier: CoreNotifier(const CoreState()),
      child: const MyApp(),
    ),
  );
}
  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        theme: ThemeData(
          scaffoldBackgroundColor:
              StateInheritedNotifier.of(context).value.backgroundColor,
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              '${StateInheritedNotifier.of(context).value.counter}',
